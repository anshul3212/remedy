...
// const reportedPosts = await prisma.posts.findMany({
//   where: {
//     post_reports: {
//       some: {},
//     },
...
//       { message: "all reported postd found", post: serialize(formattedPosts) },
//       {
//     status: 200,
//     headers: {
...
export async function GET() {
  try {
    ...
    return NextResponse.json(
      {
        message: "all reported posts found",
