...
const cardData = [
  ...
  return (
    <div className="font-inter font-bold py-8 px-14 flex flex-col gap-4 overflow-y-auto h-[calc(100vh-100px)]">
      ...
      {/* <div className="flex items-center justify-between">
        <div className="w-200 h-90 bg-white rounded-xl p-4">
          <div className="flex items-center justify-between">
            <h2 className="font-inter text-[#272424] text-lg font-semibold">
              Community
            </h2>
            <button className="text-[#8B5CF6] font-inter font-semibold text-[11px] cursor-pointer">
              Manage Posts
            </button>
          </div>
        </div>
        <div className="w-96 h-90 bg-white rounded-xl p-4 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <h2 className="font-inter text-[#272424] text-lg font-semibold">
              Library
            </h2>
            <button className="cursor-pointer bg-[#8B5CF6] px-4 py-2 rounded-md flex items-center justify-center">
              <span className="text-[#ffffff] font-inter font-semibold text-[11px] ">Create Article</span>
            </button>
          </div>

          <div className="flex items-center justify-between">
            <div className="bg-[#F8FAFC] rounded-md flex items-center justify-center flex-col gap-4 w-40 p-6">

                <span className="text-xl font-inter font-bold text-[#272424]">72</span>
                <span className="text-lg font-inter font-medium text-[#00000078]">PUBLISHED</span>

            </div>

             <div className="bg-[#F8FAFC] rounded-md flex items-center justify-center flex-col gap-4 p-6 w-40">

                <span className="text-xl font-inter font-bold text-[#272424]">12</span>
                <span className="text-lg font-inter font-medium text-[#00000078]">DRAFTS</span>

            </div>
          </div>

          <div className="bg-[#FAF5FF] w-full p-4 flex flex-col gap-2">
            <span className="font-inter text-[#000000] text-xs font-medium">Review Required</span>
            <span className="font-inter text-[#8B5CF6] text-[9px] font-medium">3 articles from guest physicians are pending editorial approval. </span>
