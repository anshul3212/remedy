...
import {BarChart2, Dot, Eye, Flag, Megaphone, MonitorDot, Tv, UsersRound } from "lucide-react";
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-4">
            ...
            <button onClick={()=>router.push("/community/channel-management/add-channels")} className="p-4 flex items-center gap-3 rounded-md shadow-[0px_0px_2.51px_0px_#00000040] cursor-pointer">
                ...
                <span className="text-sm text-black font-inter font-medium">Create Channel</span>
            </button>

            <button className="p-4 flex items-center gap-3 rounded-md shadow-[0px_0px_2.51px_0px_#00000040] cursor-pointer">
                <Flag size={20} color="#000" />
                <span className="text-sm text-black font-inter font-medium">Moderate Reports</span>
            </button>
             </div>
      </div>
    </div>
